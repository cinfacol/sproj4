    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_address', models.CharField(max_length=150, verbose_name='Dir_de_envio')),
                ('billing_address', models.CharField(max_length=150, verbose_name='Dir_de facturacion')),
                ...
                ('address_type', models.CharField(choices=[('billing_address', 'billing'), ('shipping_address', 'send')], default='shipping_address', max_length=50)),
