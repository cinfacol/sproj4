# Generated by Django 4.0 on 2022-03-29 22:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to='perfiles.userbase')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('residencia_address', models.CharField(max_length=150, verbose_name='Dirección de residencia')),
                ('oficina_address', models.CharField(max_length=150, verbose_name='Dirección de oficina')),
                ...
                ('address_type', models.CharField(choices=[('Dirección de Facturación', 'billing'), ('Dirección de Envío', 'send')], default='Dirección de Envío', max_length=50)),
                ('default', models.BooleanField(default=False)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='perfiles.userbase')),
            ],
            options={
